...
\begin{document}
	...
	\begin{figure*}[h]
		...
		\caption{Valores de impedancia en funci\'on de la frecuencia para los resultados experimentales (izquierda) y las simulaciones (derecha) de \ce{LiClO4}. En l\'ineas cont\'inuas la magnitud.}
		\label{fig: voltajes}
	\end{figure*}
